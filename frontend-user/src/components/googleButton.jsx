...
import { Button, createMuiTheme, Icon, makeStyles, ThemeProvider, Typography, useMediaQuery } from "@material-ui/core";
...
const useStyles = makeStyles((theme) => ({
  ...
  btnGoogle: {
    ...
    transition: "-webkit-filter 220ms cubic-bezier(0.4, 0, 0.2, 1) 220ms, background-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,border 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms",
    "&:hover": {
      "& $btnGoogleImg": {
